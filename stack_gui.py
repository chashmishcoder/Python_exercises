...
class StackVisualizer:
      def __init__(self, root):
          self.window = root
          self.window.config(bg="HotPink4")
          ...
          #Make canvas
          self.stack_canvas = Canvas(self.window, width=self.canvas_width, height=self.canvas_height,bg="HotPink4", relief=RAISED, bd=10)
      ...
      def heading_and_sub_heading(self): #Main heading, sub heading and indicator label set
          self.heading_name = Label(self.stack_canvas, text="Stack Visualizer", bg="HotPink4", fg="white", font=("Helvetica",30,"bold","italic"))
          self.heading_name.place(x=140,y=30)

          self.sub_heading = Label(self.stack_canvas, text="Index number", bg="HotPink4", fg="#99ff33",  font=("Helvetica",20,"bold","italic"))
          self.sub_heading.place(x=20,y=300)

          self.stack_indicator = Label(self.stack_canvas, text="Stack Container", bg="HotPink4", fg="black",  font=("Helvetica",20,"bold","italic"))
          self.stack_indicator.place(x=180,y=450)

      def make_buttons(self): #Make Buttons to access and make top with arrow
          self.push_btn = Button(self.window,text="PUSH",fg="black",bg="lime green",font=("Arial",15,"bold"),
                                 relief=RAISED,bd=7,command=self.push_element)
          self.push_btn.place(x=30,y=535)

          self.pop_btn = Button(self.window, text="POP", fg="black", bg="lime green", font=("Arial", 15, "bold"),
                                relief=RAISED,bd=7,command=self.pop_data)
          self.pop_btn.place(x=500, y=535)

          self.top_index = Label(self.window, text="<---- top", fg="white", bg="HotPink4", font=("Arial", 20, "bold"))
      ...
      def set_index(self): #Index of the stack set
          self.index_neg = Label(self.stack_canvas,text="-1",fg="blue",bg="HotPink4",font=("Arial",15,"bold"))
          self.index_neg.place(x= 215, y=403)

          self.index_0 = Label(self.stack_canvas, text="0", fg="blue", bg="HotPink4", font=("Arial", 15, "bold"))
          self.index_0.place(x=220, y=365)

          self.index_1 = Label(self.stack_canvas, text="1", fg="blue", bg="HotPink4", font=("Arial", 15, "bold"))
          self.index_1.place(x=220, y=332)

          self.index_2 = Label(self.stack_canvas, text="2", fg="blue", bg="HotPink4", font=("Arial", 15, "bold"))
          self.index_2.place(x=220, y=299)

          self.index_3 = Label(self.stack_canvas, text="3", fg="blue", bg="HotPink4", font=("Arial", 15, "bold"))
          self.index_3.place(x=220, y=266)

          self.index_4 = Label(self.stack_canvas, text="4", fg="blue", bg="HotPink4", font=("Arial", 15, "bold"))
          self.index_4.place(x=220, y=232)

          self.index_5 = Label(self.stack_canvas, text="5", fg="blue", bg="HotPink4", font=("Arial", 15, "bold"))
          ...
          if len(self.last_label_value_keep) == 6:
             messagebox.showerror("Overflow","Stack is full")
              ...
              self.element_take_label = Label(self.window,text="Enter the element value",
                                         bg="pink",fg="brown",font=("Arial",12,"bold"))
              ...
              self.add_btn = Button(self.window, text="Add", font=("Arial", 10, "bold"), bg="black", fg="red", relief=RAISED, bd=3, padx=3, pady=3, command=lambda: self.make_block('<Return>'))
